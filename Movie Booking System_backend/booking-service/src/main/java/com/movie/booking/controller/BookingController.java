...
public class BookingController {
    ...
    // reintiate payments for pre-existing bookings
    @PatchMapping("/{id}/reinitiate-payment")
    public ResponseEntity<BookingResponseDto> reinitiatePayment(
            @PathVariable Long id) {
        BookingResponseDto response = bookingService.confirmBookingWithPayment(id);
